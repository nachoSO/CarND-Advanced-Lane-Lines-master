...
def sliding_line_finding(binary_warped):
    left_lane  = Line()
    right_lane = Line()
...
def line_finding_after_sliding(binary_warped,left_lane,right_lane):
...
def draw(binary_warped, left_lane, right_lane, image, Minv):
